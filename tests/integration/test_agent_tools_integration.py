...
class TestAgentToolsIntegration:
    ...
    def test_agent_chained_read_write(self, mock_agent, tmp_path):
        ...
        summaries1 = mock_agent._handle_tool_calls(tool_calls)
        ...
        summaries2 = mock_agent._handle_tool_calls(tool_calls)
...
class TestAgentToolErrorHandling:
    ...
    def test_agent_handles_tool_timeout(self, mock_agent, mocker):
        ...
        mocker.patch.dict("coding_agent.tools.AVAILABLE_TOOLS",
                    {"run_terminal_command": lambda command, **kwargs: "Error: The command timed out"})
