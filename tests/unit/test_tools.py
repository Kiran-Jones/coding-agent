...
class TestRunTerminalCommand:
    ...
    def test_run_terminal_command_timeout(self, mocker):
        ...
        mock_proc.wait.side_effect = subprocess.TimeoutExpired(cmd="sleep 200", timeout=120)
    ...
    def test_run_terminal_command_invalid_command(self):
        ...
        assert "Error" in result or "not found" in result.lower() or "Exception" in result
...
class TestWebSearch:
    ...
    def test_web_search_success(self, mocker):
        ...
        mocker.patch("coding_agent.tools.DDGS").return_value.__enter__.return_value.text.return_value = mock_results
    ...
    def test_web_search_no_results(self, mocker):
        ...
        mocker.patch("coding_agent.tools.DDGS").return_value.__enter__.return_value.text.return_value = []
...
class TestGitCommands:
    ...
    def test_run_git_command_timeout(self, mocker):
        ...
        mocker.patch("subprocess.run", side_effect=subprocess.TimeoutExpired("git", 120))
